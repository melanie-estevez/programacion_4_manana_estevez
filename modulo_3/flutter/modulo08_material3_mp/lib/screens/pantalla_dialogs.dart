  ...
  Future<void> _mostrarConfirmacion(BuildContext context) async {
    final confirmar = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          '¿Estás seguro de que deseas eliminar Lomo Saltado?\n'
  ...
  Future<void> _mostraralertanueva(BuildContext context) async {
    final confirmar = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Alerta de Plato Eliminado'),
        content: const Text(
          'Dessea Eliminar?'
  ...
  Future<void> _mostrarFormulario(BuildContext context) async {
    ...
    if (ctrlNombre.text.isNotEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Plato "${ctrlNombre.text}" agregado',
          ),
        ),
      );
    }
      ...
      body: ListView(
        ...
        children: [
          ...
          OutlinedButton.icon(
            ...
            label:
                const Text('Eliminar plato (confirmación)'),
          ),
          ...
          FilledButton.tonal(
            ...
            child:
                const Text('Agregar plato (formulario)'),
          ),
